...
export default function AdminProfesionales() {
  ...
  return (
    <div className="p-8">
      <div className="mb-6">
        <h1 className="font-heading text-2xl font-semibold text-text-strong">Profesionales</h1>
        <p className="font-body text-sm text-text-soft mt-1">Gestiona todos los profesionales de la plataforma</p>
      </div>

      <div className="grid grid-cols-2 gap-4 mb-6">
        <div className="bg-white rounded-2xl p-5 shadow-sm">
          <p className="font-body text-xs text-text-soft mb-2">Total profesionales</p>
      ...
      <div className="bg-white rounded-2xl p-6 shadow-sm">
        <div className="flex justify-between items-center mb-5">
          <h2 className="font-heading text-base font-semibold text-text-strong">Lista de profesionales</h2>
        ...
        {loading ? (
          ...
          <p className="font-body text-sm text-text-soft">Sin profesionales registrados.</p>
        ) : (
          <>
